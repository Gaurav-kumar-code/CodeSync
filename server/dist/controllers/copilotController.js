...
exports.runCopilotActionController = void 0;
...
const runCopilotActionController = async (req, res) => {
    try {
        const { action, userPrompt, fileName, fileContent } = req.body;
        ...
        const result = await (0, copilotService_1.runGeminiCopilotAction)({
            action,
            userPrompt,
            fileName,
            fileContent,
...
exports.runCopilotActionController = runCopilotActionController;
